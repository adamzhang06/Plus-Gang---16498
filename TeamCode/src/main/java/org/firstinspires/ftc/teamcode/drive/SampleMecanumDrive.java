...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(3, 0, 0); //TODO 3,0,0
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(0.8, 0.15, 0); //TODO changed kI to 0.15 and kP to 0.6 (0.025), 0.6 to 0.8

    public static double LATERAL_MULTIPLIER = 1.40626203;
...
//        rightFront = hardwareMap.get(DcMotorEx.class, "frontRight ");
    ...
    public TrajectorySequenceBuilder trajectorySequenceBuilder(Pose2d startPose) { // TODO we added this
        return new TrajectorySequenceBuilder(
                startPose,
                VEL_CONSTRAINT, ACCEL_CONSTRAINT,
                MAX_ANG_VEL, MAX_ANG_ACCEL
