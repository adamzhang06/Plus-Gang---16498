 ...
 */
@Config
@Autonomous(name = "RedLeft_Fast", group = "3RedLeft")
public class RedLeft_Fast extends LinearOpMode {
    // initialize motors
    ...
    public void runOpMode() throws InterruptedException {
        ...
        int slow = 20;
        int armHeight = -4950; //TODO used to be -5150
...
//spikeLeft
        TrajectorySequence spikeLeft = drive.trajectorySequenceBuilder()
                ...
                //TODO too far left
                .lineToLinearHeading(
                        new Pose2d(32, -60, Math.toRadians(-90)),
                        SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .lineToLinearHeading(
                        new Pose2d(32, -80.5, Math.toRadians(-90)),
...
//spikeCenter
        TrajectorySequence spikeCenter = drive.trajectorySequenceBuilder()
                ...
                .waitSeconds(2) //TODO calibrate time
                .lineToLinearHeading(
                        new Pose2d(22, -70, Math.toRadians(-90)),
                        SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .lineToLinearHeading(
                        new Pose2d(22, -80, Math.toRadians(-90)),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
...
//spikeRight
        TrajectorySequence spikeRight = drive.trajectorySequenceBuilder()
                ...
                .lineToLinearHeading(
                        new Pose2d(19.5, -80, Math.toRadians(-90)),
                        SampleMecanumDrive.getVelocityConstraint(slow, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .lineToLinearHeading(
                        new Pose2d(16.25, -80, Math.toRadians(-90)),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
